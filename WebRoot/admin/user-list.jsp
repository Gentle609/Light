...
<script type="text/javascript">
	function tiao() {
		window.location.href = "../FindUserServlet";
	}
</script>
<style type="text/css">
.page {
					...
					<form action="../FindUserServlet" method="post">
						<ul class="search_content clearfix">
							<li><label class="l_f">用户名称</label><input name="name"
								type="text" class="text_add" placeholder="输入姓名"
							...
							<tbody>
								...
								<tr>
									<td colspan="7">
										...
										<div class="page">
											<a href="user-list.jsp?page=1">首页</a> <a
												href="user-list.jsp?page=<%=curPage - 1 > 0 ? curPage - 1 : 1%>">上一页</a>
											<a
												href="user-list.jsp?page=<%=curPage + 1 < pageTotal ? curPage + 1 : pageTotal%>">下一页</a>
											<a href="user-list.jsp?page=<%=pageTotal%>">尾页</a>
										</div>
									</td>
								</tr>
								<%
